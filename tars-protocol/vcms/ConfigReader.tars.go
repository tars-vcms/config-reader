...
//PutConfig is the proxy function for the method defined in the tars file, with the context
func (_obj *ConfigReader) PutConfig(req *PutConfigReq, rsp *PutConfigRsp, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(tarsCtx, 0, "PutConfig", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
//PutConfigWithContext is the proxy function for the method defined in the tars file, with the context
func (_obj *ConfigReader) PutConfigWithContext(tarsCtx context.Context, req *PutConfigReq, rsp *PutConfigRsp, _opt ...map[string]string) (ret int32, err error) {
...
//PutConfigOneWayWithContext is the proxy function for the method defined in the tars file, with the context
func (_obj *ConfigReader) PutConfigOneWayWithContext(tarsCtx context.Context, req *PutConfigReq, rsp *PutConfigRsp, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(tarsCtx, 1, "PutConfig", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *ConfigReader) GetConfig(req *GetConfigReq, rsp *GetConfigRsp, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *ConfigReader) GetConfigWithContext(tarsCtx context.Context, req *GetConfigReq, rsp *GetConfigRsp, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *ConfigReader) GetConfigOneWayWithContext(tarsCtx context.Context, req *GetConfigReq, rsp *GetConfigRsp, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *ConfigReader) SetServant(s m.Servant) {
	_obj.s = s
}

//TarsSetTimeout sets the timeout for the servant which is in ms.
func (_obj *ConfigReader) TarsSetTimeout(t int) {
	_obj.s.TarsSetTimeout(t)
}

//TarsSetProtocol sets the protocol for the servant.
func (_obj *ConfigReader) TarsSetProtocol(p m.Protocol) {
	_obj.s.TarsSetProtocol(p)
}

//AddServant adds servant  for the service.
func (_obj *ConfigReader) AddServant(imp _impConfigReader, obj string) {
	tars.AddServant(_obj, imp, obj)
}

//AddServant adds servant  for the service with context.
func (_obj *ConfigReader) AddServantWithContext(imp _impConfigReaderWithContext, obj string) {
	tars.AddServantWithContext(_obj, imp, obj)
}

type _impConfigReader interface {
	PutConfig(req *PutConfigReq, rsp *PutConfigRsp) (ret int32, err error)
	GetConfig(req *GetConfigReq, rsp *GetConfigRsp) (ret int32, err error)
}
type _impConfigReaderWithContext interface {
	PutConfig(tarsCtx context.Context, req *PutConfigReq, rsp *PutConfigRsp) (ret int32, err error)
...
func (_obj *ConfigReader) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	var length int32
	var have bool
	var ty byte
	...
	case "PutConfig":
		...
		if _withContext == false {
			_imp := _val.(_impConfigReader)
			_funRet_, err = _imp.PutConfig(&req, &rsp)
		} else {
			_imp := _val.(_impConfigReaderWithContext)
			_funRet_, err = _imp.PutConfig(tarsCtx, &req, &rsp)
		}
